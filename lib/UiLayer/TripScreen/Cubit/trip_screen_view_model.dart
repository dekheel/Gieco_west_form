...
class TripScreenViewModel extends Cubit<ReportStates> {
  TripScreenViewModel({Key? key}) : super(ReportInitialState());
...
//    //basic info
  ...
  //train info
  String? trainType;
  TextEditingController coachQtyCtrl = TextEditingController();
  String? trainState;
  String? trainEmpty;
  TextEditingController waybillNoCtrl = TextEditingController();
  TextEditingController tariffCtrl = TextEditingController();
  TextEditingController firstCoachNoCtrl = TextEditingController();
  TextEditingController lastCoachNoCtrl = TextEditingController();
  TextEditingController sebensaNoCtrl = TextEditingController();
  bool trainSecurity = false;
  TextEditingController tempStationCtrl = TextEditingController();

  //trip  info
  TextEditingController tripTypeCtrl = TextEditingController();
  TextEditingController depStationCtrl = TextEditingController();
  TextEditingController depTimeCtrl = TextEditingController();
  TextEditingController nxtArrFromdepStationCtrl = TextEditingController();
  TextEditingController gazOnDepCtrl = TextEditingController();

  TextEditingController arrStationCtrl = TextEditingController();
  ...
  TextEditingController trainConductorCtrl = TextEditingController();
  TextEditingController trainConductorSapCtrl = TextEditingController();
...
// global note
  ...
  TripReport getReportModel(BuildContext context) {
    TripReport reportModel = TripReport(
      ...
      stockTripReportData: StockTripReportData(
        ...
        lastCoachNo: lastCoachNoCtrl.text,
        sebensaNo: sebensaNoCtrl.text,
        trainSecurity: trainSecurity ? "نعم" : "لا",
        tempStation:
            tempStationCtrl.text.isEmpty ? "لا يوجد" : tempStationCtrl.text,
      ),
      employeeReportData: EmployeeReportData(
        ...
        trainConductor: trainConductorCtrl.text,
        trainConductorSap: trainConductorSapCtrl.text,
      ),
      tripType: tripTypeCtrl.text,
      depStation: depStationCtrl.text,
      nxtArrFromdepStation: nxtArrFromdepStationCtrl.text,
...
//    //basic info
    ...
    waybillNoCtrl.clear();
    tariffCtrl.clear();
    firstCoachNoCtrl.clear();
    lastCoachNoCtrl.clear();
    sebensaNoCtrl.clear();
    trainSecurity = false;
    tempStationCtrl.clear();

    //trip  info
    tripTypeCtrl.clear();
    depStationCtrl.clear();
    nxtArrFromdepStationCtrl.clear();
    arrStationCtrl.clear();
    depTimeCtrl.clear();
    arrTimeCtrl.clear();
    gazOnDepCtrl.clear();
    gazOnArrCtrl.clear();
